---
name: end-work
description: Use when finishing work on a kata-tracked issue in this repo — e.g. "end work on 9t8x", "ship kata 9t8x", "wrap up <ref>". Takes the worktree branch through PR, green checks, squash merge, verified green run on main, then closes the kata and the worktree.
---
